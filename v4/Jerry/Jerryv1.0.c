#pragma config(Sensor, dgtl1,  Transmit,       sensorDigitalOut)
#pragma config(Sensor, dgtl2,  flyEnc,         sensorQuadEncoder)
#pragma config(Motor,  port1,           InMot,         tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           LDrive,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           midleft,       tmotorVex393_MC29, openLoop, reversed)
